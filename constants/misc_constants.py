...
GEO_DATA_NETWORK_DIR = os.path.join("SUN-GI-FieldSampleGeoData")
GEO_DATA_NETWORK_DIR_DELETIONS = os.path.join("SUN-GI-metadb-test", "Deleted FieldSampleGeoData (DO NOT TOUCH)")
GEO_DATA_PROJECTS_DIR_PATH = os.path.join(PATH_TO_MOUNT, GEO_DATA_NETWORK_DIR, "Projects")
