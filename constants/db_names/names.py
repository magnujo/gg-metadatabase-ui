...
class data(Schema):
    ...
    class field_sample(Table):
        ...
        #  Columns:
        field_sample_id = lambda template=False: get_column_name(303, template=template, testing=True)
        country_ocean = lambda template=False: get_column_name(304, template=template, testing=True)
        site_name = lambda template=False: get_column_name(305, template=template, testing=True)
        latitude = lambda template=False: get_column_name(306, template=template, testing=True)
        longitude = lambda template=False: get_column_name(307, template=template, testing=True)
        sample_date = lambda template=False: get_column_name(308, template=template, testing=True)
        sample_provider_name = lambda template=False: get_column_name(309, template=template, testing=True)
        running_project_title = lambda template=False: get_column_name(310, template=template, testing=True)
        sampling_depth = lambda template=False: get_column_name(311, template=template, testing=True)
        sampling_interval___to = lambda template=False: get_column_name(312, template=template, testing=True)
        water_depth = lambda template=False: get_column_name(313, template=template, testing=True)
        sample_type = lambda template=False: get_column_name(314, template=template, testing=True)
        sample_context = lambda template=False: get_column_name(316, template=template, testing=True)
        sample_environment = lambda template=False: get_column_name(315, template=template, testing=True)
        age_estimate___from = lambda template=False: get_column_name(317, template=template, testing=True)
        elevation = lambda template=False: get_column_name(318, template=template, testing=True)
        sample_storage_address = lambda template=False: get_column_name(319, template=template, testing=True)
        sample_storage_setting = lambda template=False: get_column_name(320, template=template, testing=True)
        sample_storage_location = lambda template=False: get_column_name(321, template=template, testing=True)
        miscellaneous_sample_measurement_or_observation = lambda template=False: get_column_name(322, template=template, testing=True)
        miscellaneous_environmental_measurement_or_observation = lambda template=False: get_column_name(323, template=template, testing=True)
        link_to_images = lambda template=False: get_column_name(324, template=template, testing=True)
        link_to_other_relevant_information = lambda template=False: get_column_name(325, template=template, testing=True)
        comments = lambda template=False: get_column_name(326, template=template, testing=True)
        database_insert_by = lambda template=False: get_column_name(327, template=template, testing=True)
        from_spreadsheet = lambda template=False: get_column_name(328, template=template, testing=True)
        database_insert_datetime_utc = lambda template=False: get_column_name(329, template=template, testing=True)
        upload_uuid = lambda template=False: get_column_name(330, template=template, testing=True)
        sampling_interval___from = lambda template=False: get_column_name(331, template=template, testing=True)
        age_estimate___to = lambda template=False: get_column_name(332, template=template, testing=True)
        sample_material = lambda template=False: get_column_name(333, template=template, testing=True)
        alias = lambda template=False: get_column_name(334, template=template, testing=True)
        cultural_affiliation = lambda template=False: get_column_name(335, template=template, testing=True)
        museum_institution = lambda template=False: get_column_name(336, template=template, testing=True)
        pi = lambda template=False: get_column_name(338, template=template, testing=True)
        sample_provider_contact = lambda template=False: get_column_name(339, template=template, testing=True)
        site_grid_elev = lambda template=False: get_column_name(340, template=template, testing=True)
        site_grid_latitude = lambda template=False: get_column_name(341, template=template, testing=True)
        site_grid_longitude = lambda template=False: get_column_name(342, template=template, testing=True)
        master_id_parent_sample_id = lambda template=False: get_column_name(343, template=template, testing=True)
        field_label = lambda template=False: get_column_name(344, template=template, testing=True)
        sample_type_in_storage_at_gm = lambda template=False: get_column_name(345, template=template, testing=True)
        permit_for_dna_analysis = lambda template=False: get_column_name(346, template=template, testing=True)
        sample_environment_secondary = lambda template=False: get_column_name(387, template=template, testing=True)
        parent_id = lambda template=False: get_column_name(410, template=template, testing=True)
        geographical_location_names = lambda template=False: get_column_name(414, template=template, testing=True)
        owned_by_aegis = lambda template=False: get_column_name(415, template=template, testing=True)
        part_of_aegis = lambda template=False: get_column_name(578, template=template, testing=True)
        template_version = lambda template=False: get_column_name(610, template=template, testing=True)
        data_quality_comments = lambda template=False: get_column_name(609, template=template, testing=True)
        sample_created_from = lambda template=False: get_column_name(577, template=template, testing=True)
        other_sample_ids = lambda template=False: get_column_name(576, template=template, testing=True)
        coordinates_inference_method = lambda template=False: get_column_name(580, template=template, testing=True)
        elevation_inference_method = lambda template=False: get_column_name(581, template=template, testing=True)
        depth_inference_method = lambda template=False: get_column_name(582, template=template, testing=True)
        sample_description = lambda template=False: get_column_name(583, template=template, testing=True)
        taxonomy_id = lambda template=False: get_column_name(584, template=template, testing=True)
        age_inference_method = lambda template=False: get_column_name(585, template=template, testing=True)
        geological_time_period = lambda template=False: get_column_name(586, template=template, testing=True)
        primary_sampling_method = lambda template=False: get_column_name(587, template=template, testing=True)
        collected_as_field_control = lambda template=False: get_column_name(588, template=template, testing=True)
        sampling_responsible = lambda template=False: get_column_name(589, template=template, testing=True)
        sampling_institution = lambda template=False: get_column_name(590, template=template, testing=True)
        field_trip_staff = lambda template=False: get_column_name(591, template=template, testing=True)
        other_sampling_details = lambda template=False: get_column_name(592, template=template, testing=True)
        sampling_medium = lambda template=False: get_column_name(593, template=template, testing=True)
        sampling_medium_details = lambda template=False: get_column_name(594, template=template, testing=True)
        broad_scale_environmental_context = lambda template=False: get_column_name(595, template=template, testing=True)
        local_scale_environmental_context = lambda template=False: get_column_name(596, template=template, testing=True)
        primary_depositional_environment = lambda template=False: get_column_name(597, template=template, testing=True)
        secondary_depositional_environment = lambda template=False: get_column_name(598, template=template, testing=True)
        permafrosted = lambda template=False: get_column_name(599, template=template, testing=True)
        archaeological_registry_number = lambda template=False: get_column_name(600, template=template, testing=True)
        archaeological_context_description = lambda template=False: get_column_name(601, template=template, testing=True)
        archaeological_context_identifier = lambda template=False: get_column_name(602, template=template, testing=True)
        feature_function_class = lambda template=False: get_column_name(603, template=template, testing=True)
        template_fillers = lambda template=False: get_column_name(604, template=template, testing=True)
        sample_contacts = lambda template=False: get_column_name(605, template=template, testing=True)
        other_storage_details = lambda template=False: get_column_name(606, template=template, testing=True)
        acquisition_type = lambda template=False: get_column_name(607, template=template, testing=True)
        other_values = lambda template=False: get_column_name(608, template=template, testing=True)
        site_description = lambda template=False: get_column_name(579, template=template, testing=True)
