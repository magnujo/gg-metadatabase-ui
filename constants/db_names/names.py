...
class db_names(Schema):
    ...
    class flowcell(Table):
        ...
        clusters = lambda template=False: get_column_name(161, template=template)
        clusters = lambda template=False: get_column_name(162, template=template)
        yield_2 = lambda template=False: get_column_name(163, template=template)
    ...
    class field_sample(Table):
        ...
        sample_provider = lambda template=False: get_column_name(309, template=template)
        ...
        sample_provider = lambda template=False: get_column_name(339, template=template)
