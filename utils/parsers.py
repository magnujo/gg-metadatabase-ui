...
def parse(sheet, 
    ...
    col_dtypes = col_dtypes[~col_dtypes['column_name'].isin(misc_constants.AUTO_GENERATED_COLUMNS)]
    ...
    expected_columns = [element for element in expected_columns if element not in misc_constants.AUTO_GENERATED_COLUMNS]
