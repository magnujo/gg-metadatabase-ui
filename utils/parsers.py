...
def parse(sheet, 
    ...
    auto_generated_cols = db_schema[(db_schema['auto_generated']) & (db_schema['table_name'] == database_table_name) & (db_schema['schema_name'] == schema_name)]['column_name_db'].tolist()
    auto_generated_cols = auto_generated_cols + misc_constants.SCRIPT_GENERATED_COLUMNS
    
    #Remove the autogenerated ones, as we don't want to parse those.
    col_dtypes = col_dtypes[~col_dtypes['column_name'].isin(auto_generated_cols)]
